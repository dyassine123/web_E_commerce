          ...
          <div class="wrap-address-billing">
            ...
            <div class="billing-address">
              ...
              <p class="row-in-form">
                ...
                <input  type="text" name="Line1" value="" placeholder="Line1" wire:model="line1">
                @error('line1') <span class="text-danger">{{$message}}</span> @enderror
              </p>
              <p class="row-in-form">
                <label for="add">Line2:</label>
                <input  type="text" name="Line1" value="" placeholder="Line1" wire:model="line2">
         ...
         <div class="col-md-12">
          <div class="wrap-address-billing">
            ...
            <div class="billing-address">
              ...
              <p class="row-in-form">
                <label for="add">Line1:</label>
                <input  type="text" name="Line1" value="" placeholder="Line1" wire:model="s_line1">
                @error('s_line1') <span class="text-danger">{{$message}}</span> @enderror
              </p>
              <p class="row-in-form">
                <label for="add">Line2:</label>
                <input  type="text" name="Line1" value="" placeholder="Line1" wire:model="s_line2">
