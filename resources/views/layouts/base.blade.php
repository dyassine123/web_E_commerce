								...
								@auth
									...
									<li class="menu-item menu-item-has-children parent">
										...
										<ul class="submenu curency">
											...
											<li class="menu-item">
												<a title="clients" href="{{route('admin.users')}}">clients</a>
											</li>
											<li class="menu-item">
									...
									@else
									<li class="menu-item menu-item-has-children parent">
										<a title="MY Account" href="{{route('logout')}}">MY Account {{ Auth::user()->name }}<i class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="submenu curency">
											<li class="menu-item">
